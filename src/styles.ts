export const classNames = {
  ...
  heroText:
    'text-center text-3xl sm:text-4xl lg:text-5xl font-[600] sm:leading-9 tracking-wide text-mx-black',

  subHeroText:
    'mt-3 text-center text-xs sm:text-sm font-medium tracking-wide text-mx-grey-2',
